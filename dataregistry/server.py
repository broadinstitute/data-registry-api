...
CALR_ROUTES_WITHOUT_AUTH = {'download_calr_file', 'get_calr_file_info', 'list_public_calr_submissions', 'convert_calr_files', 'get_calr_session', 'download_calr_session_csv'}
